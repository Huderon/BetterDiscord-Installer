...
<div class="social-links">
    <a use:tooltip={{text: "Website"}} aria-label="Website" class="social" id="web" target="noopener noreferrer _blank" href={webUrl} {onclick}>
    ...
    <a use:tooltip={{text: "GitHub"}} aria-label="GitHub" class="social" id="github" target="noopener noreferrer _blank" href={githubUrl} {onclick}>
    ...
    <a use:tooltip={{text: "Donate"}} aria-label="Donate" class="social" id="donate" target="noopener noreferrer _blank" href={donateUrl} {onclick}>
