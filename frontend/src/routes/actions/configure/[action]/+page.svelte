<script lang="ts">
    ...
    const titleByAction: Record<InstallerAction, string> = {
        ...
        repair: "Configure Repair",
        uninstall: "Configure Uninstall"
    };

    const subtitleByAction: Record<InstallerAction, string> = {
        install: "Choose how the installer should handle the final steps.",
